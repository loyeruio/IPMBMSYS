...
import com.ipmbmsys.common.annotation.DataScope;
...
import com.ipmbmsys.common.utils.bean.BeanValidators;
import com.ipmbmsys.common.utils.spring.SpringUtils;
import com.ipmbmsys.system.domain.SysUserPost;
import com.ipmbmsys.system.domain.SysUserRole;
import com.ipmbmsys.system.mapper.SysPostMapper;
import com.ipmbmsys.system.mapper.SysRoleMapper;
import com.ipmbmsys.system.mapper.SysUserMapper;
import com.ipmbmsys.system.mapper.SysUserPostMapper;
import com.ipmbmsys.system.mapper.SysUserRoleMapper;
...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    public String importUser(List<SysUser> userList, Boolean isUpdateSupport, String operName)
    {
     ...
     /**
     * 根据条件分页查询用户列表（包含角色和职务信息）
     *
     * @param user 用户信息
     * @return 用户信息集合（包含角色职务信息）
     */
    @Override
    @DataScope(deptAlias = "d", userAlias = "u")
    public List<Map<String, Object>> selectUserListWithRolesAndPosts(SysUser user)
    {
        return userMapper.selectUserListWithRolesAndPosts(user);
    }
}
