...
import com.ipmbmsys.system.domain.SysRoleMenu;
import com.ipmbmsys.system.domain.SysUserRole;
import com.ipmbmsys.system.mapper.SysRoleDeptMapper;
import com.ipmbmsys.system.mapper.SysRoleMapper;
import com.ipmbmsys.system.mapper.SysRoleMenuMapper;
...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    /**
     * 根据用户ID查询用户实际拥有的角色（仅返回已分配的角色）
     * 
     * @param userId 用户ID
     * @return 用户实际拥有的角色列表
     */
    @Override
    public List<SysRole> selectUserOwnedRoles(Long userId)
    {
