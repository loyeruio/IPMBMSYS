...
public class SysDept extends BaseEntity {
    ...
    @NotBlank(message = "党组织名称不能为空")
    @Size(min = 0, max = 30, message = "党组织名称长度不能超过30个字符")
    ...
    public String getOrganizationAbbr() {
        return organizationAbbr;
    }

    public void setOrganizationAbbr(String organizationAbbr) {
        this.organizationAbbr = organizationAbbr;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("organizationAbbr", getOrganizationAbbr())
