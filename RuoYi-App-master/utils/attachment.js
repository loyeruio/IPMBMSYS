...
export class AttachmentManager {
  constructor(options = {}) {
    // 获取基础 API 地址，优先使用环境变量，否则使用配置文件
    const baseApi = config.baseUrl;
    
    this.uploadUrl = options.uploadUrl || baseApi + "/common/upload";
    this.downloadUrl = options.downloadUrl || baseApi + "/common/download/resource";
