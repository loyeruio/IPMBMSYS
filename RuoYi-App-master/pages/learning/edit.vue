  ...
  <view class="edit-container">
    ...
    <view v-else class="form-container">
      <view class="form-header">
        <text class="form-title">修改半月学活动</text>
      </view>
...
<script>
import { getLearning, updateLearning } from '@/api/learning/learning'
  ...
  methods: {
    ...
    async handleSubmit() {
      try {
        ...
        const response = await updateLearning(this.formData)
